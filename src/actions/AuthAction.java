...
public class AuthAction extends ActionBase {
    ...
    public void login() throws ServletException, IOException {
        ...
        String userId = getRequestParam(AttributeConst.USER_ID);
        String plainPass = getRequestParam(AttributeConst.USER_PASS);
        String pepper = getContextScope(PropertyConst.PEPPER);

        //有効な利用者か認証する
        Boolean isValidEmployee = service.validateLogin(userId, plainPass, pepper);
        ...
        if (isValidEmployee) {
            ...
            //入力されたユーザーIDを設定
            putRequestScope(AttributeConst.USER_ID, userId);
